...
ETRModels <- SolFitsMeta %>%
  ...
  mutate(LRC_Param = map(LRC_model, broom::tidy),
        LRC_Qual = map(LRC_model, broom::glance),
        LRC_Predict = map(LRC_model, broom::augment)) |>
 ...
 mutate(LRCplatt_Param = map(LRCplatt_model, broom::tidy),
        LRCplatt_Qual = map(LRCplatt_model, broom::glance),
        LRCplatt_Predict = map(LRCplatt_model, broom::augment))
