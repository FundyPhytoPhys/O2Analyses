...
```
caption:Light response curves of photosynthetic activity. 
this plot shows the light response curves of photosynthetic activity for three *prochlorococcus* strains under different light intensities and oxygen concentrations. the green points represent the experimental data, the black line denotes the fitted model, and the red points denote residual values.
...
ETRModelsParam |>
  ...
  theme_bw()
```
caption: Analysis of Photosynthetic Parameters 
This plot presents an analysis of phtotosynthetic parameters derived from the previous light response curve plot. the estimates of maximum photosynthetic rate (Pmax) are showed against varying oxygen concentrations, with error bars representing the standard error. Data is grouped by strains and light intensities, providing insights into the relationship between oxygen concentration and Pmax across different experimental conditions. 
