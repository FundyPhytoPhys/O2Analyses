...
TestFile3 <- read_delim_plus(flnm = "../Data/RawData/DualPAM/Report/202311141453_PICO_JuNa1246_250.csv", delimiter = Delimiter, headerrows = DataHeaderRows, fileencode = FileEncode)

|>
    slice_tail(n = max(which(.$Action == "LC-Start"))) 
...
LastLRCRow <- max(which(TestFile$Action == "LC-Start"))
LastLRCRow
