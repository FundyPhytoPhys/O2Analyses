...
read_delim_DualPAM <- function(flnm, delimiter, headerrows, fileencode)
  {DataFile <- read_delim_plus(flnm, delimiter = Delimiter, headerrows = DataHeaderRows, fileencode = FileEncode)
