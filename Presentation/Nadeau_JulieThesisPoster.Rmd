...
<p class="forceBreak"></p>
- Cell pellets were obtained by centrifuging samples frozen in liquid nitrogen and stored at -80°C for future transcriptomic analyses.
- Whole Cell Absorbance Spectra were measured using an Integrating Cavity Spectrophotometer at 250 or 2 µM O2 to monitor electron carrier reduction status.
- Chlorophyll a concentrations were determined for each sample to assess photosynthetic pigment content and its correlation with oxygen levels.
